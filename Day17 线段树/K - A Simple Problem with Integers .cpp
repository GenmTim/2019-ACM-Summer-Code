...
bool cmp(Data one, Data tow){ return one.a > tow.a; }
...
int main(){
	...
	For(i,1,n) { Sca(num[i].b); tmp[i]=num[i].b; }
...
//	}
	For(i,2,n){
		if(num[i].a<minn){ minn=num[i].a;  For(j,l,i-1) t.updata(num[j].b,1,num[j].c); l=i; }
